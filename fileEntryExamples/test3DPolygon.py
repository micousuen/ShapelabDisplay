...
polygon = {"geometryType": "polygon", \
		   "geometryName": "3D-polygon", \
		   # Contour should follow clockwise or counter-clockwise order
		   "geometryData": [[0, 0, 0], [1, 0, 1/2], [1, 1, 1], [0, 1, 1/2] ], \
...
dataString = json.dumps([polygon, {"GroupProperties":{"GroupName":"3D-Polygon"}, "username": "admin", "password": "admin"}], sort_keys=True)
