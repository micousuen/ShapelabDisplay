...
// Database root address, generated by using default value
...
module.exports = {
    ...
    connect: function(forWhat, mongoServer = DBaddress, mongoPort = DBport, mongoUsername = DBusername, mongoPassword = DBpassword){
        DBurl = 'mongodb://'+mongoUsername.toString()+':'+mongoPassword.toString()+'@'+mongoServer.toString()+':'+mongoPort.toString()+'/'+DBname.toString();
